    ...
    <div className="welcome-page-container">
      ...
      <section id="our-mission">
        ...
        <p className="text-styling">
          ...
          difference. Whether you're a seasoned environmental enthusiast or just
          starting your journey towards sustainability, you'll find inspiration,
          tips, and resources to help you play your part in preserving our
          beautiful Earth.
        </p>
        <img
